...
# flutter学习（四）Flutter与Native交互（Android百度地图与Flutter交互实战）

## flutter与原生交互原理

> Flutter与Native之间的通信是采用双通道事件传递机制，通过MethodChannel进行传递数据，通信原理如下图（官网图片）

![image](https://github.com/XiaoCheng123/markdownImg/blob/master/flutter%E5%9B%BE%E7%89%87/7.png?raw=true)
...
![image](https://github.com/XiaoCheng123/markdownImg/blob/master/flutter%E5%9B%BE%E7%89%87/8.png?raw=true)
